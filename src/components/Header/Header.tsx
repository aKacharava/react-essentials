...
export function Header(
    ...
    const description: string = reactDescriptions[genRandomInt(2)];
    ...
    return (
        <header className="flex flex-col items-center text-center mx-12 mb-10">
            ...
            <p className="m-0 text-lg">
                { props.dynamicText } ipsum dolor sit amet, consectetur adipiscing elit. Cras ac quam vehicula ipsum vulputate ultrices.
